...
public class POPSMO26_Popbitch_Free_Period_From_Finish_Notice {
	WebDriver driver;
	...
	@Then("wallet tab displays free")
	@Test(priority=166)
	public void wallet_tab_displays_free() throws InterruptedException {
		Wallet_Elements w1 = new Wallet_Elements(driver);
		w1.Click_On_popbitch_staging_agate_poster();
		String actual_current_balance=w1.current_balance();
	...
	@Then("twenty fivep is deducted from the wallet")
	@Test(priority=167)
	public void twenty_fivep_is_deducted_from_the_wallet() throws InterruptedException {
		Wallet_Elements w1 = new Wallet_Elements(driver);		
		String actual_current_balance=w1.current_balance();
		String expected_current_balance="9.50";
		Assert.assertEquals(actual_current_balance, expected_current_balance);
